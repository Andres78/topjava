...
public class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    public void testGet() throws Exception {
        TestUtil.print(mockMvc.perform(MockMvcRequestBuilders.get(ProfileRestController.REST_URL)
    ...
    public void testDelete() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(ProfileRestController.REST_URL)
                .with(TestUtil.userHttpBasic(USER)))
                .andExpect(status().isOk());
    ...
    public void testUpdate() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put(ProfileRestController.REST_URL).contentType(MediaType.APPLICATION_JSON)
                .with(TestUtil.userHttpBasic(USER))

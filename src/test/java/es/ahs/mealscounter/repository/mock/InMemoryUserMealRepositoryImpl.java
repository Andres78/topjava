package es.ahs.mealscounter.repository.mock;

import es.ahs.mealscounter.UserTestData;
import es.ahs.mealscounter.model.UserMeal;
import es.ahs.mealscounter.repository.UserMealRepository;
...
public class InMemoryUserMealRepositoryImpl implements UserMealRepository {
    ...
    {
        UserMealsUtil.MEAL_LIST.forEach(um -> save(um, UserTestData.USER_ID));

        save(new UserMeal(LocalDateTime.of(2016, Month.JUNE, 1, 14, 0), "Админ ланч", 510), UserTestData.ADMIN_ID);
        save(new UserMeal(LocalDateTime.of(2016, Month.JUNE, 1, 21, 0), "Админ ужин", 1500), UserTestData.ADMIN_ID);
    }
